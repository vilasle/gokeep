...
func (m *MockUserRepository) Add(arg0 context.Context, arg1 UserAdd) (int, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) Find(arg0 context.Context, arg1 string) (UserInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) Get(arg0 context.Context, arg1 int) (UserInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) Update(arg0 context.Context, arg1 UserUpdate) error {
	m.ctrl.T.Helper()
...
// Add mocks base method.
func (m *MockPrivateDataRepository) Add(ctx context.Context, data PrivateDataSave) (int, error) {
	m.ctrl.T.Helper()
...
// Get mocks base method.
func (m *MockPrivateDataRepository) Get(arg0 context.Context, arg1 int) (PrivateDataInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", arg0, arg1)
...
func (m *MockPrivateDataRepository) List(ctx context.Context, modelType Type, userID int) ([]PrivateDataInfo, error) {
	m.ctrl.T.Helper()
...
// Update mocks base method.
func (m *MockPrivateDataRepository) Update(ctx context.Context, data PrivateDataSave) (int, error) {
	m.ctrl.T.Helper()
