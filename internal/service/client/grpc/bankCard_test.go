...
func TestBankCardService_New(t *testing.T) {
	...
	_ = NewBankCardService(clientConn)
}

func TestBankCardService_Save(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		req := client.BankCardSaveRequest{
			Number:  "1234567890",
			Expires: "12/20",
			CVV:     123,
		...
		mock.EXPECT().SaveBankCard(ctx, &proto.SaveBankCardRequest{
			Number:     req.Number,
			Expires:    req.Expires,
			Cvv:        int64(req.CVV),
