...
func TestTextService_List(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		svc := NewTextService(manager, masterKey)
		...
		private.EXPECT().List(ctx, model.TypePlainText, 1).Return([]model.PrivateDataInfo{
			{
				ID:     1,
				UserID: 1,
	...
	t.Run("empty list", func(t *testing.T) {
		...
		private.EXPECT().List(ctx, model.TypePlainText, 1).Return([]model.PrivateDataInfo{}, nil)
...
func TestTextService_Get(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		defer ctrl.Finish()
...
func TestTextService_Add(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		defer ctrl.Finish()
		...
		_, err := svc.Add(ctx, service.AddTextData{
			Name:   "123456890",
			Text:   []byte("123456890"),
			UserID: userID,
			Metadata: []service.MetadataValue{
...
func TestTextService_Update(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		defer ctrl.Finish()
		...
		_, err := svc.Update(ctx, service.UpdateTextData{
			ID: 1,
			AddTextData: service.AddTextData{
				Name:   "123456890",
				Text:   []byte("123456890"),
				UserID: userID,
			},
