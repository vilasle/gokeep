...
func TestLoginPasswordService_New(t *testing.T) {
	...
	_ = NewLoginPasswordDataService(clientConn)
}

func TestLoginPasswordService_Save(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		req := client.LoginPasswordSaveRequest{
			Login:    "login",
			Password: "password",
		...
		mock.EXPECT().SaveLoginPassword(ctx, &proto.SaveLoginPasswordRequest{
			Login:      "login",
			Password:   "password",
...
func TestLoginPasswordService_Get(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		ctx := context.Background()
		ctrl := gomock.NewController(t)
		defer ctrl.Finish()
...
func TestLoginPasswordService_Delete(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		ctx := context.Background()
		ctrl := gomock.NewController(t)
		defer ctrl.Finish()
