...
func TestBinaryDataService_List(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		svc := NewBinaryDataService(manager, masterKey)
		...
		private.EXPECT().List(ctx, model.TypeBinaryData, 1).Return([]model.PrivateDataInfo{
			{
				ID:     1,
				UserID: 1,
	...
	t.Run("empty list", func(t *testing.T) {
		...
		private.EXPECT().List(ctx, model.TypeBinaryData, 1).Return([]model.PrivateDataInfo{}, nil)
...
func TestBinaryDataService_Add(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		defer ctrl.Finish()
		...
		_, err := svc.Add(ctx, service.AddBinaryData{
			Name:   "123456890",
			Data:   []byte("123456890"),
			UserID: userID,
			Metadata: []service.MetadataValue{
...
func TestBinaryDataService_Update(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		defer ctrl.Finish()
		...
		_, err := svc.Update(ctx, service.UpdateBinaryData{
			ID: 1,
			AddBinaryData: service.AddBinaryData{
				Name:   "123456890",
				Data:   []byte("123456890"),
				UserID: userID,
			},
