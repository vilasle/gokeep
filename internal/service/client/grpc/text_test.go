...
func TestTextDataService_New(t *testing.T) {
	...
	_ = NewTextDataService(clientConn)
}

func TestTextDataService_Save(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		req := client.TextDataSaveRequest{
			Name: "name",
		...
		mock.EXPECT().SaveTextData(ctx, &proto.SaveTextDataRequest{
			Data:       []byte("data"),
			Name:       "name",
...
func TestTextDataService_Get(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		ctx := context.Background()
		ctrl := gomock.NewController(t)
		defer ctrl.Finish()
...
func TestTextDataService_Delete(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		mock.EXPECT().Delete(ctx, &proto.DeleteDataRequest{
			Id:         1,
			Credential: &proto.ConfirmAssess{Token: req.JWT},
			Type:       int32(model.TypePlainText),
